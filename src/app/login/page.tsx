        ...
        <div className="relative z-10 rounded-[32px] border border-slate-100 bg-white/70 px-8 py-10 shadow-xl backdrop-blur-xl sm:px-12">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm font-medium text-slate-500">
              Sign in to unlock unlimited conversions
            </p>
          </div>
          ...
          <form onSubmit={handleCredentialsSubmit} className="space-y-5">
            ...
            <div>
              <label
                htmlFor="password"
                className="mb-1.5 flex items-center justify-between text-xs font-bold uppercase tracking-wide text-slate-500"
              >
                <span>Password</span>
                <Link
            ...
            >
              {isLoading ? "Signing in..." : "Sign in to Convertz"}
            </button>
          </form>
